...
# отрядов, а также их урон. Есть два отряда, в каждом по 10 монстров.
...
squad_3_condition = [('Dead' if squad_1[i_damage]
                                 + squad_2[i_damage] > 100 else 'Survive')
                     for i_damage in range(10)]

print(f'Damage of the first squad is: {squad_1}')
print(f'Damage of the second squad is: {squad_2}')
print(f'Condition of the third squad is: {squad_3_condition}')